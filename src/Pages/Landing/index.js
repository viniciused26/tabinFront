    ...
    <Box sx={{ flexGrow: 1 }}>
      <Fab style={windowSize[0] <= 768 ? fabStyleSmall : fabStyle}>
        <a href="https://wa.link/sq3or5">
          <img
            src={WppIcon}
            style={windowSize[0] < 768 ? { width: "130%" } : { width: "150%" }}
          />
        </a>
      </Fab>
      <ContainerWithImg style={{ height: windowSize[1] + 32 }}>
        <Grid
          ...
          spacing={2}
          rowSpacing={8}
          style={windowSize[0] < 768 ? { padding: "15%" } : { padding: "7%" }}
        >
          {/* <Grid item xs={0} /> */}
          <Grid item xs={12}>
            <Typography
              variant={windowSize[0] < 768 ? "h4" : "h3"}
              color="white"
              style={
                windowSize[0] < 768
                  ? { textAlign: "center", fontSize: "100%" }
                  : { textAlign: "center", fontSize: "300%" }
              }
            >
              Reduza custos operacionais e aumente a margem de lucro do seu
              negócio com nosso cardápio digital 100% gratuito!
            </Typography>
          </Grid>
          {/* <Grid item xs={0} /> */}
          ...
          <Grid item xs={8} style={{ textAlign: "center" }}>
            <Typography
              ...
              style={
                windowSize[0] < 768
                  ? { textAlign: "center", fontSize: "90%" }
                  : { textAlign: "center", fontSize: "200%" }
              }
            >
              Ideal para restaurantes, lanchonetes, bares, cafeterias, padarias
              etc
            </Typography>
          </Grid>
          <Grid item xs={2} />
          ...
          <Grid item xs={8} style={{ textAlign: "center" }}>
            <img
              src={ArrowsDownIcon}
              style={windowSize[0] < 768 ? { width: "20%" } : { width: "5%" }}
            />
          </Grid>
          <Grid item xs={2} />
        </Grid>
      ...
      <Container style={{ height: windowSize[1] + 64 }}>
        ...
        >
          ...
          <Grid item xs={windowSize[0] < 768 ? 6 : 3}>
            <img
              src={RestaurantIcon}
              style={windowSize[0] < 768 ? { width: "80%" } : { width: "60%" }}
            />
            <div style={{ height: "5%" }}></div>
            <Typography
              variant={windowSize[0] < 768 ? "h6" : "h5"}
              style={
                windowSize[0] < 768 ? { fontSize: "70%" } : { fontSize: "150%" }
              }
              color="primary"
            >
          ...
          <Grid item xs={windowSize[0] < 768 ? 6 : 3}>
            <img
              src={CodeIcon}
              style={windowSize[0] < 768 ? { width: "60%" } : { width: "40%" }}
            />
            <div style={{ height: "5%" }}></div>
            <Typography
              variant={windowSize[0] < 768 ? "h6" : "h5"}
              ...
              color="primary"
            >
              2. Usa a câmera do celular dele para ler o cardápio QR code da
              mesa.
            </Typography>
          </Grid>
          <Grid item xs={windowSize[0] < 768 ? 6 : 3}>
            <img
              src={BellIcon}
              style={windowSize[0] < 768 ? { width: "65%" } : { width: "45%" }}
            />
            <div style={{ height: "5%" }}></div>
            <Typography
              variant={windowSize[0] < 768 ? "h6" : "h5"}
          ...
          <Grid item xs={windowSize[0] < 768 ? 6 : 3}>
            <img
              src={ComputerIcon}
              style={windowSize[0] < 768 ? { width: "85%" } : { width: "65%" }}
            />
            <div style={{ height: "5%" }}></div>
            <Typography
              variant={windowSize[0] < 768 ? "h6" : "h5"}
      ...
      <Container
        style={
          windowSize[0] <= 1024
            ? { height: windowSize[1] + 410, backgroundColor: "#551f5f" }
            : { height: windowSize[1] + 64, backgroundColor: "#551f5f" }
        }
      >
        <Grid
          container
          ...
          rowSpacing={4}
          columnSpacing={2}
          style={windowSize[0] < 768 ? { padding: "7%" } : { padding: "5%" }}
        >
          <Grid item xs={6} style={{ textAlign: "left" }}>
            <img
              src={GraphIcon}
              style={windowSize[0] < 768 ? { width: "20%" } : { width: "7%" }}
            />
            <div style={{ height: "5%" }}></div>
            <Typography
              variant={windowSize[0] < 768 ? "subtitle2" : "h5"}
              color="white"
            ...
            <Typography
              ...
              color="white"
            >
              Elimine os custos de papelaria do seu cardápio e campainha
              eletrônica.
            </Typography>
          </Grid>
          <Grid item xs={6} style={{ textAlign: "left" }}>
          ...
          <Grid item xs={6} style={{ textAlign: "left" }}>
            ...
            <Typography
              ...
              color="white"
            >
              Crie contas para seus colaboradores e limite as funções de cada
              conta.
            </Typography>
          </Grid>
          <Grid item xs={6} style={{ textAlign: "left" }}>
      ...
      <ContainerWithImg2
        style={{ height: windowSize[1] + 64, position: "relative" }}
      >
        <Grid
          container
          spacing={2}
        ...
        >
          <Grid item xs={12}>
            ...
            >
              Ferramenta totalmente grátis, sem taxas de adesão e sem cadastro
          ...
          <Grid item xs={12}>
            <Typography
              variant={windowSize[0] < 768 ? "h4" : "h5"}
              color="white"
              style={
                windowSize[0] < 768
                  ? { textAlign: "center", fontSize: "100%" }
          ...
          <Grid item xs={8} style={{ textAlign: "center" }}>
            <Button
              ...
              style={
                windowSize[0] < 768
                  ? { background: "#53AA45", width: "90%", fontSize: "70%" }
                  : { background: "#53AA45" }
              }
      ...
      <Cookies openDialog={openDialog} setOpenDialog={setOpenDialog} />
    </Box>
  );
};
